      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            ...
            var minSrc = 'https://raw.githubusercontent.com/cherryzzangg/blog-album/master/min_photos/'+ data.link[i];
			      //var minSrc = 'http://cherryzzangg.coding.net/p/Hexo-Workspace/d/Hexo-Workspace/git/blob/master/album/min_photos/' + data.link[i];
           // var src = 'https://raw.githubusercontent.com/yourgithub/Blog_Album/master/photos/' + data.link[i];
            //var src = 'http://cherryzzangg.coding.net/p/Hexo-Workspace/d/Hexo-Workspace/git/blob/master/album/photos/' + data.link[i];
            var src ='https://raw.githubusercontent.com/cherryzzangg/blog-album/master/photos/'+ data.link[i];
